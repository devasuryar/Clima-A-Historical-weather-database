			...
			<div class="site-header">
				...
				<div class="main-navigation">
						...
						<ul class="menu">
                                                        ...
                                                        <li class="menu-item current-menu-item"><a href="customer1.jsp">View Report</a></li>
					...
					<main class="main-content">
			 		<div class="container">
					   <div class="breadcrumb">
                                               <a href="customer1.jsp"><b><%=username%></b></a>
...
%> 
                                        ...
                                        <br><form action="customer1.jsp" method="post" class="contact-form">
